$(document).ready(function() {
    ...
    window.LoadItemData = function(ProductId) {
        ...
        <div class="w-full flex md:flex-row flex-col my-2 md:border-2 md:border-black rounded-lg border-0 !gap-y-3 md:gap-0">
        <button class="!w-full md:w-6/12 hover:bg-green-500 py-4 md:border-e-2 rounded-s-lg border-2 md:border-0 border-black text-lg font-bold mx-auto md:mx-0">Add To Cart <i class="fa-solid fa-bag-shopping"></i></button>
        <button class="!w-full md:w-6/12 py-4 rounded-e-lg hover:bg-blue-500 text-lg font-bold mx-auto border-black border-2 md:border-0 md:mx-0">Add To Wishlist <i class="fa-regular fa-bookmark"></i></button>
        </div>
        </div>
